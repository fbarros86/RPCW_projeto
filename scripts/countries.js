...
rows_facil = ["continente","hemisferio","latitude","longitude","temperatura_media"]
rows_medio = ["gdp","area","densidade_populacional","lado_em_que_conduz","populacao"]
rows_dificil = ["taxa_desemprego","taxa_fertilidade","racio_sexos","emissoes_co2","telefones_por_1000","taxa_de_natalidade","taxa_de_mortalidade","costa","espetativa_de_vida","exportacoes","importacoes","literacia","migracao_liquida","mortalidade_infantil"]
...
module.exports = { getRandomColumns, getAllFlags,getCountryInfo, compareCountries, addCountry, deleteCountry, editCountry};
